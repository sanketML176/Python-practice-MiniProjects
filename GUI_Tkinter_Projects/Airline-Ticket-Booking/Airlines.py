...
# a=PhotoImage(file="profile2.gif")
#Label(fr1,image=a).pack()
fr2=Frame()
fr2.pack(side=LEFT,expand=1)
Label(fr2,text="Flight Ticket Booking Portal",font=("sans-serif",30),compound="center",fg="Black").pack()
Label(fr2,text="Service Provider Details",font=("Arial",14),fg="Black",compound="center").pack()
Label(fr2,text="Sanket Panchalwar",font=("Arial",10),fg="Black",compound="center").pack()
# Label(fr2,text="151385 ",font=("sans-serif",14),fg="Red",compound="center").pack()
# Label(fr2,text="B-5",font=("sans-serif",14),compound="center",fg="Red").pack()
Label(fr2,text="Email-sanketsrp176@gmail.com",font=("Arial",10),fg="Black",compound="center").pack()
...
def airline():
    ...
    Label(root1,text="Welcome to SP Airline",font=("sans-serif",17),fg="Black",width=46,bg="White").grid(row=0,column=0,columnspan=4)
    Label(root1,text="Flights Availability",font=("sans-serif",17),fg="White",width=46,bg="red").grid(row=1,column=0,columnspan=4)
    Label(root1,text="Select Pick Up Point",font=("sans-serif",14),fg="Black").grid(row=2,column=1)
    variable = StringVar(root1)
    variable.set("Select Source") # default value
    w = OptionMenu(root1, variable, "Delhi", "Pune", "Mumbai","U.S.A","Canada")
    w.grid(row=2,column=2)
    Label(root1,text="Select Boarding Point",font=("sans-serif",14),fg="Black").grid(row=3,column=1)
    variable1 = StringVar(root1)
    variable1.set("Select Destination") # default value
    w = OptionMenu(root1, variable1, "Delhi", "Pune", "Mumbai","U.S.A","Canada")
    ...
    def signup():
                 ...
                 Label(root,text="Welcome to SP Airlines",font=("sans-serif",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                 Label(root,text="Sign Up",font=("sans-serif",17),fg="White",width=46,bg="red").grid(row=1,column=0,columnspan=4)
                 Label(root,text="Username*",font=("sans-serif",14),fg="Black").grid(row=2,column=1)
                 user_name=Entry()
                 user_name.grid(row=2,column=2)
                 Label(root,text="First Name",font=("sans-serif",14),fg="Black").grid(row=3,column=1)
                 first_name=Entry()
                 first_name.grid(row=3,column=2)
                 Label(root,text="Last Name",font=("sans-serif",14),fg="Black").grid(row=4,column=1)
                 last_name=Entry()
                 last_name.grid(row=4,column=2)
                 Label(root,text="Phone Number",font=("sans-serif",14),fg="Black").grid(row=5,column=1)
                 phone_number=Entry()
                 phone_number.grid(row=5,column=2)
                 Label(root,text="Email*",font=("sans-serif",14),fg="Black").grid(row=6,column=1)
                 email=Entry()
                 email.grid(row=6,column=2)
                 Label(root,text="Password*",font=("sans-serif",14),fg="Black").grid(row=7,column=1)
                 passw=Entry(root,show="*")
                 passw.grid(row=7,column=2)
                 Button(root,text="Sign up",fg="white",bg="red",font=("sans-serif",10),command=lambda: success()).grid(row=8,columnspan=5)
                 def signin():
                     root.destroy()
                     root2=Tk()
                     root2.title("Sign In")
                     ...
                     Label(root2,text="Welcome to SP Airlines",font=("sans-serif",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                     Label(root2,text="Sign In",font=("sans-serif",17),fg="White",width=46,bg="red").grid(row=1,column=0,columnspan=4)
                     Label(root2,text="Username*",font=("sans-serif",14),fg="Black").grid(row=2,column=1)
                     user_name=Entry()
                     user_name.grid(row=2,column=2)
                     Label(root2,text="Password*",font=("sans-serif",14),fg="Black").grid(row=3,column=1)
                     ...
                     def bookingportal():
                          ...
                          if a==[]:
                                ...
                                Label(root4,text="Welcome to SP Airlines",font=("sans-serif",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                                Label(root4,text="Booking Portal",font=("sans-serif",17),fg="White",width=46,bg="red").grid(row=1,column=0,columnspan=4)
                                Label(root4,text="Enter Your Details",font=("sans-serif",14),fg="Black",width=46).grid(row=2,column=0,columnspan=4)
                                Label(root4,text="Full Name      ",font=("sans-serif",14),fg="Black").grid(row=3,column=1, sticky='w')
                                name=Entry()
                                name.grid(row=3,column=2)
                                Label(root4,text="Enter Your age ",font=("sans-serif",14),fg="Black").grid(row=4,column=1, sticky='w')
                                age=Entry(width=4)
                                age.grid(row=4,column=2)
                                Label(root4,text="Select Gender  ",font=("sans-serif",14),fg="Black").grid(row=5,column=1, sticky='w')
                                a=IntVar()
                                Radiobutton(root4,text="Male",variable=a,value=0,fg="red").grid(row=5,column=2, sticky='w')
                                Radiobutton(root4,text="Female",variable=a,value=1,fg="red").grid(row=5,column=3, sticky='w')
                                Label(root4,text="Seat Class     ",font=("sans-serif",14),fg="Black").grid(row=6,column=1, sticky='w')
                                v= StringVar(root4)
                                v.set("Select class") # default value
                                w = OptionMenu(root4, v, "First Class", "Business Class", "Economy Class")
                                w.grid(row=6,column=2)
                                Label(root4,text="Additional Passengers Details",font=("sans-serif",14),fg="Black",width=46).grid(row=7,column=0,columnspan=4)
                                Label(root4,text="Passenger1     ",font=("sans-serif",14),fg="Black").grid(row=8,column=1, sticky='w')
                                name1=Entry()
                                name1.grid(row=8,column=2)
                                Label(root4,text="Enter Your age ",font=("sans-serif",14),fg="Black").grid(row=9,column=1, sticky='w')
                                age1=Entry(width=4)
                                age1.grid(row=9,column=2)
                                Label(root4,text="Seat Class     ",font=("sans-serif",14),fg="Black").grid(row=10,column=1, sticky='w')
                                v1= StringVar(root4)
                                v1.set("Select class") # default value
                                w1 = OptionMenu(root4, v1, "First Class", "Business Class", "Economy Class")
                                w1.grid(row=10,column=2)
                                Label(root4,text="Passenger2     ",font=("sans-serif",14),fg="Black").grid(row=11,column=1, sticky='w')
                                name2=Entry()
                                name2.grid(row=11,column=2)
                                Label(root4,text="Enter Your age ",font=("sans-serif",14),fg="Black").grid(row=12,column=1, sticky='w')
                                age2=Entry(width=4)
                                age2.grid(row=12,column=2)
                                Label(root4,text="Seat Class     ",font=("sans-serif",14),fg="Black").grid(row=13,column=1, sticky='w')
                                v2= StringVar(root4)
                                v2.set("Select class") # default value
                                w2 = OptionMenu(root4, v2, "First Class", "Business Class", "Economy Class")
                                w2.grid(row=13,column=2)
                                Label(root4,text="Passenger3     ",font=("sans-serif",14),fg="Black").grid(row=14,column=1, sticky='w')
                                name3=Entry()
                                name3.grid(row=14,column=2)
                                Label(root4,text="Enter Your age ",font=("sans-serif",14),fg="Black").grid(row=15,column=1, sticky='w')
                                age3=Entry(width=4)
                                age3.grid(row=15,column=2)
                                Label(root4,text="Seat Class     ",font=("sans-serif",14),fg="Black").grid(row=16,column=1, sticky='w')
                                v3= StringVar(root4)
                                v3.set("Select class") # default value
                                w3 = OptionMenu(root4, v3, "First Class", "Business Class", "Economy Class")
                                w3.grid(row=16,column=2)
                                Label(root4, text="Journey Date: ",font=("sans-serif",14),fg="Black").grid(row=17,column=1, sticky='w')
                                date = Entry(root4, width=15, font=("sans-serif", 14),fg="Black")
                                date.grid(row=17, column=2)
                                date.insert(0,"DD/MM/YYYY")
                                Label(root4,text="Number of Passengers",font=("sans-serif",14),fg="Black").grid(row=18,column=1, sticky='w')
                                v4= StringVar(root4)
                                ...
                                def data():
                                        ...
                                        Label(root5,text="Thanks For Choosing Air India",font=("sans-serif",17),fg="White",bg="red",width=46).grid(row=0,column=0,columnspan=4)
                                        Label(root5,text="Ticket Details",font=("sans-serif",17),fg="Black",width=46).grid(row=1,column=0,columnspan=4)
                                        Label(root5,text="Passenger Name",font=("Arial",14),fg="Black").grid(row=2,column=1)
                                        Label(root5,text=name.get(),font=("Arial",14),fg="Black").grid(row=2,column=2)
                                        Label(root5,text="Age",font=("Arial",14),fg="Black").grid(row=3,column=1)
                                        Label(root5,text=age.get(),font=("Arial",14),fg="Black").grid(row=3,column=2)
                                        Label(root5,text="Gender",font=("Arial",14),fg="Black").grid(row=4,column=1)
                                        if(a.get()==0):
                                        ...
                                        Label(root5,text="Class",font=("Arial",14),fg="Black").grid(row=5,column=1)
                                        Label(root5,text=v.get(),font=("Arial",14),fg="Black").grid(row=5,column=2)
                                        Label(root5,text="Date",font=("Arial",14),fg="Black").grid(row=6,column=1)
                                        Label(root5,text=date.get(),font=("Arial",14),fg="Black").grid(row=6,column=2)
                                        Label(root5,text="Additional Passenger Details",font=("sans-serif",17),fg="Black",width=46).grid(row=7,column=0,columnspan=4)
                                        Label(root5,text="Passenger Name",font=("Arial",14),fg="Black").grid(row=8,column=1)
                                        Label(root5,text=name1.get(),font=("Arial",14),fg="Black").grid(row=8,column=2)
                                        Label(root5,text="Class",font=("Arial",14),fg="Black").grid(row=9,column=1)
                                        Label(root5,text=v1.get(),font=("Arial",14),fg="Black").grid(row=9,column=2)
                                        Label(root5,text="Passenger Name",font=("Arial",14),fg="Black").grid(row=10,column=1)
                                        Label(root5,text=name2.get(),font=("Arial",14),fg="Black").grid(row=10,column=2)
                                        Label(root5,text="Class",font=("Arial",14),fg="Black").grid(row=11,column=1)
                                        Label(root5,text=v2.get(),font=("Arial",14),fg="Black").grid(row=11,column=2)
                                        Label(root5,text="Passenger Name",font=("Arial",14),fg="Black").grid(row=12,column=1)
                                        Label(root5,text=name3.get(),font=("Arial",14),fg="Black").grid(row=12,column=2)
                                        Label(root5,text="Class",font=("Arial",14),fg="Black").grid(row=13,column=1)
                                        Label(root5,text=v3.get(),font=("Arial",14),fg="Black").grid(row=13,column=2)
                                        Label(root5,text="Amount Per Passsenger",font=("sans-serif",17),fg="Black",width=46).grid(row=14,column=0,columnspan=4)
                                        ...
                                        def amount(price):
                                                ...
                                                if (int(v4.get())==1):
                                                     ...
                                                     if(v.get()=="First Class"):
                                                        ...
                                                        Label(root5,text="Total Amount",font=("Arial",14),fg="Black").grid(row=18,column=1)
                                        ...
                                        Button(root5,text="Price",font=("sans-serif"),fg="white",bg="red",command=amount(0)).grid(row=20,columnspan=5)
                                        ...
                                        def exitw():
                                            root4.destroy()
                                            root5.destroy()
                                        Button(root5,text="Done",font=("sans-serif"),fg="white",bg="red",command=exitw).grid(row=19,columnspan=5)


                          Button(root4,text="Confirm Booking",fg="white",font=("sans-serif"),bg="red",command=data).grid(row=19,columnspan=5)
                     Button(root2,text="Sign In",fg="white",bg="red",font=("sans-serif",10),command=lambda: bookingportal()).grid(row=4,columnspan=5)
                     #asd#Error for displaying the image
                 Button(root,text="Sign in",fg="white",bg="red",font=("sans-serif",10),command=signin).grid(row=9,columnspan=5)
                 #asd#Error For Displaying the Image


     #Flights Availability
    def flights():
        if variable.get()=="Delhi" and variable1.get()=="Pune":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="100",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Delhi" and variable1.get()=="Mumbai":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="250",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        ...
        if variable.get()=="Delhi" and variable1.get()=="Canada":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="201",font=("sans-serif",14),fg="white",bg="green").grid(row=4,columnspan=5,column=2)
        if variable.get()=="Pune" and variable1.get()=="Delhi":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="100",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Pune" and variable1.get()=="Mumbai":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="150",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Pune" and variable1.get()=="U.S.A":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="115",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Pune" and variable1.get()=="Canada":
            showerror('Oops!',"Sorry No direct flights available for this root")
        if variable.get()=="Mumbai" and variable1.get()=="Delhi":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="250",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Mumbai" and variable1.get()=="Pune":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="150",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Mumbai" and variable1.get()=="U.S.A":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="167",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Mumbai" and variable1.get()=="Canada":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="160",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="U.S.A" and variable1.get()=="Delhi":
            showerror('Oops!',"Sorry No direct flights available for this root")
        if variable.get()=="U.S.A" and variable1.get()=="Mumbai":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="167",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="U.S.A" and variable1.get()=="Pune":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="115",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="U.S.A" and variable1.get()=="Canada":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="168",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Canada" and variable1.get()=="Delhi":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="201",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Canada" and variable1.get()=="Mumbai":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="160",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="Canada" and variable1.get()=="Pune":
           showerror('Oops!',"Sorry No direct flights available for this root")
        if variable.get()=="Canada" and variable1.get()=="U.S.A":
            Label(root1,text="Number of Seats Available are:",font=("sans-serif",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="168",font=("sans-serif",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        Button(root1,text="Signup to Book",fg="white",bg="red",font=("sans-serif",10),command=signup).grid(row=7,columnspan=5)
    Button(root1,text="Show Flights",font=("sans-serif",10),fg="white",bg="red",compound="center",command=flights).grid(row=6,columnspan=5)
    root1.mainloop()
Button(fr2,text="Proceed to Booking",compound="center",bg="red",font=("sans-serif"),fg="White",command=airline).pack()
